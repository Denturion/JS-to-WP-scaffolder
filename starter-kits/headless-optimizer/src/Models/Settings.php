 ...
 * Settings Model
 *
 * @package HeadlessOptimizer\Models
 */

namespace HeadlessOptimizer\Models;
...
class Settings {
	 ...
	 * @var string
	 */
	private string $option_key = 'headless-optimizer_settings';
	...
	public function cache_set( string $key, mixed $value, int $expiration = 3600 ): bool {
		return set_transient( 'headless-optimizer_' . $key, $value, $expiration );
	}
	...
	public function cache_get( string $key ): mixed {
		return get_transient( 'headless-optimizer_' . $key );
	}
	...
	public function cache_delete( string $key ): bool {
		return delete_transient( 'headless-optimizer_' . $key );
	}
}
