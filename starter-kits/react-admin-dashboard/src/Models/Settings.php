 ...
 * Settings Model
 *
 * @package ReactAdminDashboard\Models
 */

namespace ReactAdminDashboard\Models;
...
class Settings {
	 ...
	 * @var string
	 */
	private string $option_key = 'react-admin-dashboard_settings';
	...
	public function cache_set( string $key, mixed $value, int $expiration = 3600 ): bool {
		return set_transient( 'react-admin-dashboard_' . $key, $value, $expiration );
	}
	...
	public function cache_get( string $key ): mixed {
		return get_transient( 'react-admin-dashboard_' . $key );
	}
	...
	public function cache_delete( string $key ): bool {
		return delete_transient( 'react-admin-dashboard_' . $key );
	}
}
